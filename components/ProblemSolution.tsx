...
const QUERY = `*[_type == "problemSolution"][0]{
  problemTitle,
  problemHighlight,
  problems,
  problemFooter,
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl mt-4 mb-8">
              {data.problemTitle.replace(data.problemHighlight, '')}
              <span className="text-destructive">{data.problemHighlight}</span>
              {data.problemTitle.endsWith(data.problemHighlight) ? '' : '?'}
            </h2>
          ...
          <div className="relative">
            ...
            <div className="relative glass rounded-3xl p-8 md:p-10">
              ...
              <h3 className="font-display text-3xl md:text-4xl mt-4 mb-6">
                {data.solutionTitle.replace(data.solutionHighlight, '')}
                <span className="text-gradient-gold">{data.solutionHighlight}</span>
              </h3>

              <p className="text-muted-foreground text-lg mb-8">
                At <span className="text-primary font-semibold">Refinish Pro Cleaning Solutions</span>,
                {data.solutionDescription.substring(data.solutionDescription.indexOf(' our'))}
              </p>

              <p className="text-foreground text-lg font-medium mb-8">
                {data.solutionHighlightText}
              </p>
